...
````text
- While we can use any type of database to persist the output of streaming pipelines, 
  NoSQL is the most popular choice. Here are the list of market leading NoSQL databases.
...
hbase> put 'training:hbasedemo', 1, 'cf1:column1', 'value1'
hbase> put 'training:hbasedemo', 1, 'cf1:column2', 'value2'
hbase> put 'training:hbasedemo', 4, 'cf1:column1', 'value1'
hbase> put 'training:hbasedemo', 4, 'cf1:column3', 'value3'
